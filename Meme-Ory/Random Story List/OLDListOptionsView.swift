...
struct OLDListOptionsView: View {
...
fileprivate struct OLDListOptionsView_Testing: View {
...
struct OLDListOptionsView_Previews: PreviewProvider {
    static var previews: some View {
        OLDListOptionsView_Testing()
