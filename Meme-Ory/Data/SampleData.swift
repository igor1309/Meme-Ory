...
struct SampleData {
    ...
    static let texts = [
        ...
        И еще несколько слов здесь для того, чтобы в редакторе оценить, где заканивается текст и как это выгдядит. И еще несколько слов здесь для того, чтобы в редакторе оценить, где заканивается текст и как это выгдядит. И еще несколько слов здесь для того, чтобы в редакторе оценить, где заканивается текст и как это выгдядит. И еще несколько слов здесь для того, чтобы в редакторе оценить, где заканивается текст и как это выгдядит. И еще несколько слов здесь для того, чтобы в редакторе оценить, где заканивается текст и как это выгдядит.
        """
    ]
}
